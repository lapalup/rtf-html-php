...
class State
{
    ...
    public function PrintStyle()
    {
        ...
        // Pour l'alignement on met display en inline-block pour s'assurer qu'il sera pris en compte
        if ($this->align) $style .= "display:inline-block;width:100%;text-align:" . $this->align . ";";
    ...
    public function equals($state)
    {
        ...
        //if ($this->align != $state->align) return false;
